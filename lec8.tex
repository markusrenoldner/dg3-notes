...
\vspace{0.4cm}\emph{\textbf{(Lecture 8)}}\\
...
\begin{colortheo}{Hopf--Rinow}{hopf-rinow}
...
\]
so
\begin{equation}\label{eq:dist_lower_bound}
d(\gamma(s), q) \geqslant d - s \qquad \forall\, s \in [0,d].
\end{equation}
Define
\[
...
\]
which combined with \eqref{eq:dist_lower_bound} gives $t \in J$.
