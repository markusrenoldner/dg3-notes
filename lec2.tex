...
$$g_{ij} = g\left(\frac{\mathrm{d}}{\mathrm{d} x^i}, \frac{\mathrm{d}}{\mathrm{d} x^j}\right).$$
...
\begin{align*}
    g_{ij}&=
    g_E\left(\frac{\mathrm{d}}{\mathrm{d}x^i}, \frac{\mathrm{d}}{\mathrm{d}x^j}\right) \\
    &=g_E\left(
        0\frac{\mathrm{d}}{\mathrm{d}x^1}+...+1\frac{\mathrm{d}}{\mathrm{d}x^i}+....0\frac{\mathrm{d}}{\mathrm{d}x^n},
        0\frac{\mathrm{d}}{\mathrm{d}x^1}+...+1\frac{\mathrm{d}}{\mathrm{d}x^j}+....0\frac{\mathrm{d}}{\mathrm{d}x^n}\right)\\
    &= \delta_{ij}
\end{align*}
...
\[
F^*g_{ij} = g\left(\mathrm{d}F\left(\frac{\mathrm{d}}{\mathrm{d} x^i}\right), \mathrm{d}F\left(\frac{\mathrm{d}}{\mathrm{d} x^j}\right)\right) = \frac{\partial F^a}{\partial x^i} g_{ab} \frac{\partial F^b}{\partial x^j}.
\]
...
\begin{colordef}{Gradient of a Function}{}
