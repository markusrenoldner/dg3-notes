...
In local coordinates and using the Leibnitz rule, we can easily see that the covariant derivative of a vector field $Y$ in the direction of $X$ is given by
\begin{equation}
