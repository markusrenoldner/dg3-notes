...
\begin{tikzpicture}[scale=1.5]
    ...
    \node[right, above, Leman] at (1,1) {$v \in T_p S^1$};
...
\begin{align*}
    ...
    &=\mathrm{d} \exp_p|_{vt}\left ( \dot c (t)\right )
\end{align*}


Evaluating at $t=1$ shows that $\mathrm{d} \exp_p|_{v}\left ( v\right )$ is precisely the velocity of the geodesic at $t=1$, $\dot\gamma_{p,v}(1)$.\\
